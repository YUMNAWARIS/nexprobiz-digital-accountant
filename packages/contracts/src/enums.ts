...
export const BANK_CLASSIFICATION = [
  "UNREVIEWED",
  "BUSINESS",
  "PERSONAL",
  "TRANSFER",
...
export const SANDBOX = {
  ...
  UNSUPPORTED_CASE_MESSAGE:
    "This case is not supported in the sandbox. Please review it manually.",
  HEADER_WARNING:
  ...
  DATEV_DISCLAIMER:
    "Sandbox export. Validate with a Steuerberater before production use.",
} as const;
