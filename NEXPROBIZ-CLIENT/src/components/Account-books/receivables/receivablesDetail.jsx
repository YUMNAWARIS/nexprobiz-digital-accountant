...
export function ReceivablesDetails(props) {
  const params = useParams();
  const classes = useStyles();

  const [data, loading] = useAxios({
    url: `account-books/receivables/${params.id}`,
  });
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography variant="body1" className={classes.data}>
              ...
              {data.client_details.name || "Not available"}
            </Typography>
            <Typography variant="body1" className={classes.data}>
              <strong>Vendor Email:</strong>{" "}
              {data.client_details.email || "Not available"}
            </Typography>
            <Typography variant="body1" className={classes.data}>
              <strong>Vendor Address:</strong>{" "}
              {data.client_details.address || "Not available"}
            </Typography>
            <Typography variant="body1" className={classes.data}>
            ...
            <Typography variant="body1" className={classes.data}>
              ...
              {data.is_received ? "Received" : "Not received"}
            </Typography>
            <Typography variant="body1" className={classes.data}>
