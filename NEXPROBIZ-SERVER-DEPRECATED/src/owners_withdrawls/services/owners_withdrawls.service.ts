...
export class OwnersWithdrawlsService {
  constructor(@InjectRepository(OwnersWithdrawl) private withDrawlRepo: Repository<OwnersWithdrawl>, @InjectRepository(Owners) private ownerRepo: Repository<Owners>){}
